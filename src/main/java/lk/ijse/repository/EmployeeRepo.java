...
public class EmployeeRepo {
    public static List<Employee> getAll() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            Employee employee = new Employee(Employee_id, Employee_name, Address, Contact, Date, Salary, WorkingHours, Attendance, Position);
            emList.add(employee);
        }
        return emList;
    }

    public static void save(String employeeId, String employeeName, String address, String contact, Date date, double salary, String workingHours, String attendance, String position) throws SQLException {
